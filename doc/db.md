...
- 広告主 ( `advertisers` )
  ...
  - 広告サイズ ID ( `size_id` ) -> ( `ads_sizes.size_id` )
...
```sql
INSERT INTO `advertisers` (`advertiser_id`, `advertiser_name`, `category_blocking_type`, `size_id`)
VALUES (1, "test_advertiser", 0, 1);
...
- `advertisers` には広告主の情報として、広告主 ID 、 広告主名、カテゴリブロック配信制御情報、広告サイズ ID が入っています。
